...
function renderProjects(){
  ...
  data.forEach(proj => {
    ...
    headerControls.append(btnAddCP, btnDelete);
  ...
  // Add project form with emoji picker
  ...
  `;
  projectsContainer.append(addProjectForm);
...
function showCheckpointForm(projId) {
  ...
  form.innerHTML = `
    ...
    <button onclick="addCheckpoint(${projId})">Add Checkpoint</button>
...
function showTaskForm(projId, cpId) {
  ...
  form.innerHTML = `
    ...
    <button onclick="addTask(${projId}, ${cpId})">Add Task</button>
  `;
